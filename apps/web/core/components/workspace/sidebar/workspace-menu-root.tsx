          ...
          <>
            ...
            >
              <Menu.Items as={Fragment}>
                <div
                  className={cn(
                    "fixed z-21 mt-1 flex w-[19rem] flex-col divide-y divide-subtle rounded-md border-[0.5px] border-strong bg-surface-1 shadow-raised-200 outline-none ltr:origin-top-left rtl:origin-top-right",
                    {
                      "top-11 ltr:left-14 rtl:right-14": variant === "sidebar",
                      "top-10 ltr:left-4 rtl:right-4": variant === "top-navigation",
                    }
                  )}
                >
